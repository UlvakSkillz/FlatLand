...
namespace FlatLand
{
    public class main : MelonMod
    {
        ...
        private int size;
        private bool loadMatchmaker, showMeasurements, darkMode;

        public override void OnLateInitializeMelon()
        {
            FlatLand.ModName = "FlatLand";
            FlatLand.ModVersion = "1.4.0";
            ...
            FlatLand.AddToList("Show Measurements", true, 0, "Loads a Matchmaker into FlatLand", new Tags { });
        ...
        private IEnumerator TurnOffAllExtraRootObjects()
        {
            ...
            foreach (GameObject temp in allGameObjects)
            {
                ...
                else if (temp.name == "Lighting and effects")
                {
        ...
        private void LoadFlatLand()
        {
            ...
            if (darkMode)
            {
                ...
                plane6.transform.position = new Vector3(2.8007f, size, -1.9802f);
            ...
            returnToGymPlate.transform.position = new Vector3(7.45f, 1.9f, 10.12f);
            returnToGymPlate.transform.rotation = Quaternion.Euler(90f, 122.8f, 0f);
            ...
            buttonToSwapFromFlatLand.transform.position = new Vector3(7.67f, 1.7f, 10f);
            buttonToSwapFromFlatLand.transform.localRotation = Quaternion.Euler(0f, 302.5f, 90f);
            ...
            killStructuresPlate.transform.localPosition = new Vector3(6.7536f, 1.9f, 11.4109f);
            killStructuresPlate.transform.rotation = Quaternion.Euler(90f, 122.8f, 0f);
            ...
            buttonToKillStructures.transform.localPosition = new Vector3(7.0482f, 1.7f, 11.2199f);
            buttonToKillStructures.transform.localRotation = Quaternion.Euler(0f, 302.5f, 90f);
            ...
            shiftstoneSwapper.transform.localPosition = new Vector3(6.46f, 1f, 11.76f);
            shiftstoneSwapper.transform.rotation = Quaternion.Euler(0, 211.1f, 0);
            if (loadMatchmaker)
            {
